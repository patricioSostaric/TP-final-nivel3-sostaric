    ...
    <asp:Panel ID="panelFormulario" runat="server">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="mt-2">
                    <asp:CheckBox Text="Confirmar Eliminación" ID="chkConfirmaEliminacion" runat="server" Visible="false" />
                    <asp:Button Text="Eliminar definitivo" ID="btnConfirmaEliminar" OnClick="btnConfirmaEliminar_Click"
                        CssClass="btn btn-outline-danger btn-sm" runat="server" Visible="false" />
                </div>
            </div>
